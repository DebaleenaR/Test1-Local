...
Feature: 22355
  ...
  Scenario: 22355
   ...
   Then Select "Safety View Only" Role From Sponsor User Role Dropdown
   ...
   Then Enter Text In Subject Textbox Under DETAILS Section
	 ...
	 Then Verify Country 2 Displayed Under Study Country Column For Newly Created Study Link
