...
Feature: 13383
  ...
  Scenario: 13383
   ...
   Then Enter to the application with "stevensb_1567@securepass.exostartest.com" bypass login   
   ...
   #Given Open browser and launch SIPUrl
   #When Application homepage is open
   #Then Enter to the application with "aa_7510@securepass.exostartest.com" bypass login   
   #Then Navigatetofacilityandverifydepartment1 
   #Then Logout
   Then Close the browser
